    ...
    <>
      ...
      <div id="transfer" className="flex flex-col items-center justify-center h-screen "> 
       ...
       />
        ...
        <input type="text" id="sender_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mt-8" placeholder="Sender Address" required/>
        <input type="text" id="recipient_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-12 mt-8" placeholder="Recipient Address" required/>
          <button className="px-8 py-2 font-bold rounded-lg shadow-lg l text-sky-400 bg-sky-500/30 hover:text-slate-100 hover:bg-sky-400/90 shadow-sky-400/50 " >Send</button>
        </div>
      </div>
    </>
  );
